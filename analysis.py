...
"""
Tank1 = TankV2(area=0.043355,height=0.59055,temp=291.48,liquid=beer,gas=co2,liq_holdup=1036.866,gas_pressure=2.4,bubbler_flow_vol=1.67e-5,bubbler_pressure=2.7)
...
headers,data = runSimulationSol(Tank1,dt=0.001,eval_time=1)
...
#time step analysis
"""
time_test = np.linspace(0.01,0.0001,10)
print(time_test)
final_time_data = []
for dt in time_test:
    testTank = TankV2(area=0.043355,height=0.59055,temp=291.48,liquid=beer,gas=co2,liq_holdup=1036.866,gas_pressure=2.4,bubbler_flow_vol=1.67e-5,bubbler_pressure=2.7)
    blah,data = runSimulationSol(Tank=testTank,final_percent_sol=0.99,dt=dt,eval_time=500)
